...
const DEFAULT_EVENTS = [
  { name: "No activity",                                                        duration: 120 },
  { name: "Blink Every 5 seconds",                                              duration: 60  },
  { name: "No activity",                                                        duration: 31  },
  { name: "Raise and lower eyebrows periodically",                              duration: 61  },
  { name: "No activity",                                                        duration: 31  },
  { name: "Eating chips periodically",                                          duration: 181 },
  { name: "No activity",                                                        duration: 31  },
  { name: "Eat marshmallow periodically",                                       duration: 181 },
  { name: "No activity",                                                        duration: 31  },
  { name: "Drink water",                                                        duration: 61  },
  { name: "No activity",                                                        duration: 31  },
  { name: "Clench teeth",                                                       duration: 61  },
  { name: "No activity",                                                        duration: 31  },
  { name: "Tap teeth",                                                          duration: 61  },
  { name: "No activity",                                                        duration: 31  },
  { name: "Talk: Read this: My name is X and I am participating in a research for smart glasses. Once upon a time there was a king and a queen in their kingdom. Then they had a princess. But the princess was frozen. So, they had to unfreeze her with fire. But the fire spread and the whole castle burned down. After that the king and queen had to live in exile. However, one day, an angel showed up and unfroze their daughter and brought peace to the kingdom", duration: 61 },
  { name: "No activity",                                                        duration: 31  },
  { name: "Move head and shoulders (simulate walking)",                         duration: 181 },
  { name: "No activity",                                                        duration: 31  },
  { name: "Shake head and shoulders while talking: My name is X and I am participating in a research for smart glasses. Once upon a time there was a king and a queen in their kingdom. Then they had a princess. But the princess was frozen. So, they had to unfreeze her with fire. But the fire spread and the whole castle burned down. After that the king and queen had to live in exile. However, one day, an angel showed up and unfroze their daughter and brought peace to the kingdom", duration: 181 },
  { name: "No activity",                                                        duration: 31  },
  { name: "Move your head faster",                                              duration: 61  },
  { name: "No activity",                                                        duration: 30  },
];
...
function renderEvents() {
  ...
  events.forEach((ev, idx) => {
    ...
    tr.dataset.idx = idx;
    if (running && !paused && idx === currentIdx) tr.classList.add('active-row');
...
function renderLog() {
  if (sessionLog.length === 0) {
    logBody.innerHTML = '<tr><td colspan="3" class="empty-row">No data yet — start the timer to begin.</td></tr>';
    return;
  }
  logBody.innerHTML = sessionLog.map(e => `
    <tr>
...
// ── JSON sync ────────────────────────────────────────────
function updateJson() {
  jsonArea.value = JSON.stringify(events.map(e => ({ name: e.name, duration: e.duration })), null, 2);
}
...
function updateNextUp() {
  ...
  if (next) {
    ...
    nextNameEl.textContent = next.name.length > 50 ? next.name.slice(0,48)+'…' : next.name;
  } else {
    nextUpEl.classList.add('hidden');
  }
}
